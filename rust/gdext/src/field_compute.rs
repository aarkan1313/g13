...
const BIOME_CENTROIDS: [[f32; BIOME_STRIDE]; 10] = [
    [0.15, 0.50, 0.95,  0.5,   1.0, 0.0, 0.0, 0.0],
    [0.18, 0.35, 0.55,  0.4,   0.0, 0.0, 0.0, 0.0],
    [0.35, 0.62, 0.50,  0.8,   1.0, 0.0, 0.0, 0.0],
    [0.50, 0.30, 0.85,  1.5,   2.0, 0.0, 0.0, 0.0],
    [0.58, 0.30, 0.30,  0.25,  0.0, 0.0, 0.0, 0.0],
    [0.55, 0.70, 0.35,  0.7,   1.0, 0.0, 0.0, 0.0],
    [0.50, 0.92, 0.35,  0.9,   2.0, 0.0, 0.0, 0.0],
    [0.88, 0.15, 0.25,  0.4,   1.0, 0.0, 0.0, 0.0],
    [0.85, 0.45, 0.30,  0.3,   0.0, 0.0, 0.0, 0.0],
    [0.90, 0.90, 0.30,  1.0,   2.0, 0.0, 0.0, 0.0],
];
