...
- **CURRENT / NEXT STEP: M2.4b - DEM STRUCTURAL SCAFFOLD.** Use plan `docs/superpowers/plans/2026-06-06-m2-4b-dem-structural-scaffold.md`. The WG10 mountain synthesis lesson is: explicit range/channel/pass facts first, height assembly second, visual promotion last. Make it procedural for WG13: deterministic Rust-owned region facts from seed+region, GPU for dense macro fields where useful, cached/sampled by runtime pages. Biome/temp/moisture/elevation bias style/material facts; they do not become hard terrain recipe branches in this step.
