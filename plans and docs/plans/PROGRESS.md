...
M2.4 [ ] DEM CHARACTER integration: wire character() to the DEM data (rich, well-sampled across the library). GATE(test): character varies within real slope ceilings; determinism/continuity hold. GATE(visual): world reads as varied real-terrain character.   <- CURRENT
