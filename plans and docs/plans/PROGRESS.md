...
M2.4 [~] DEM CHARACTER integration: shader now has a DEM-derived character table from dem_fingerprints.json (slope_p95, ridge_character, spectrum centroid, fine energy), continuously blended by uplift + low-frequency region field. It tunes existing M2.3 composition knobs (relief, ridge scale/gain, detail, carve) without changing biome-as-skin or replacing uplift structure. Test gate PASS (m2_4_dem_character_check: determinism, broad character variation rough 0.505..13.250, ratio spread 0.78, retained relief spread 0.96, no-cliff max step 107.9 < 180). Regressions PASS: m2_3 spread 0.71, m2_2, m2_1, m1_7c. VISUAL sign-off from human still PENDING.   <- CURRENT (awaiting visual verdict)
