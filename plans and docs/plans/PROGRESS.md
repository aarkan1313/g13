...
M2.4 [~] DEM CHARACTER integration: shader now has a DEM-derived character table from dem_fingerprints.json (slope_p95, ridge_character, spectrum centroid, fine energy), continuously blended by uplift + low-frequency region field. It tunes existing M2.3 composition knobs (relief, ridge scale/gain, detail, carve) without changing biome-as-skin or replacing uplift structure. FIRST VISUAL FAILED: too-aggressive ridge/detail mapping caused corduroy grooves / harsh walls at far-world review coords. Fixed by tightening M2.4 to subtle DEM-character ranges centered near accepted M2.3 values and expanding the gate to include those far hotspots. Test gate PASS after fix (m2_4_dem_character_check: determinism, rough 0.355..12.067, ratio spread 0.69, retained relief spread 0.97, no-cliff max step 124.3 < 180). Regressions PASS: m2_3 spread 0.80, m2_2, m2_1, m1_7c. VISUAL recheck from human still PENDING.   <- CURRENT (awaiting visual verdict)
