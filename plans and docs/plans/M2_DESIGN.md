...
- **M2.4** — DEM structural scaffold / procedural mountain-synthesis facts. Current M2.4b prototype has a WG10-like Rust recipe port, static 2D sheet, macro 3D review scene, and playable-scale calibration scene. GATE: deterministic region facts plus visual review show organized ranges/ridges/channels/passes at sane gameplay scale instead of local noise, scalar DEM grooves, or an unplayably compressed macro proof.
